...
- Reduced the npm tarball by keeping the changelog and extended documentation on GitHub instead of
  installing them with the runtime package.
- Changed README documentation links to stable GitHub URLs so they remain available from npm and
  installed copies.
